<script>
    ...
    let folders = [
        ...
        { name: 'Sent', icon: 'M3 10h10a8 8 0 018 8v2M3 10l5 5m-5-5l5-5' }, // Placeholder paths for icons
    ...
    // Map correct icons for Sent
    folders[1].icon = 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8';
</script>
